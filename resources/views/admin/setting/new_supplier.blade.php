                            ...
                            <div class="card-body">
                                <div class="mb-5 d-flex align-items-center justify-content-between">
                                    <h5 class="fw-bold mb-0 me-4">
                                        <span class="d-block mb-2">नया सप्लायर जोड़ें</span>
                                    </h5>
                                </div>
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-6 mb-4">
                                        ...
                                        <input type="text" name="name" class="form-control" placeholder="नाम दर्ज करें" value="{{ old('name') }}">
                                        @error('name')
                                    ...
                                    <div class="col-lg-6 mb-4">
                                        ...
                                        <input type="text" name="phone" class="form-control" placeholder="मोबाइल नंबर दर्ज करें" value="{{ old('phone') }}">
                                        @error('phone')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
...
<div class="col-lg-6 mb-4">
    ...
    @enderror
                                    ...
                                    <div class="col-lg-6 mb-4">
                                        ...
                                        <input type="text" name="state" class="form-control" placeholder="राज्य दर्ज करें" value="{{ old('state') }}">
                                        @error('state')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-lg-6 mb-4">
                                        ...
                                        <input type="text" name="city" class="form-control" placeholder="शहर दर्ज करें" value="{{ old('city') }}">
                                        @error('city')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
