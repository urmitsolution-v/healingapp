            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    <div class="page-header-title">
                        <h5 class="m-b-10">राज्य सूची</h5>
                    </div>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/dashboard">डैशबोर्ड</a></li>
                        <li class="breadcrumb-item">राज्य सूची</li>
                    </ul>
                </div>
        ...
        <span>पीछे</span>
            ...
            <div class="main-content">
                <div class="row">
                     ...
                     <div class="col-12">
                        <div>
                        <a href="/new-state" class="btn btn-primary d-inline-block mb-3">नया राज्य जोड़े</a>
                        </div>
                    </div>
                    @endif
                    <div class="col-lg-12">
